...
<body background="background3.png">
      ...
      <br>
      <div style="position: absolute; top: 400px; left: 1500px;">
      <form  method="POST">
    ...
    <div  style="position: absolute; top: 500px; left: 1500px;" >
    <a href="graph/voltage.php"><button class="button-48" role="button" style="width: 250px;"> Voltage</button> <br><br></a>
    <a href="graph/current.php"><button class="button-48" role="button" style="width: 250px;">Current</button><br><br></a>
    <a href="graph/power.php"><button class="button-48" role="button" style="width: 250px;">Power</button><br><br></a>
    <a href="graph/power_fac.php"><button class="button-48" role="button" style="width: 250px;">Power Factor</button><br><br></a>
  </div>
    
    <div id="courbe_volt" style="position: absolute; top: 20px; left: 20px;"></div>
    <br>
    <div id="courbe_curr" style="position: absolute; top: 500px; left: 20px;"></div>
    <br>
    <div id="courbe_power_factor" style="position: absolute; top: 20px; left: 740px;"></div>
    <br>
    <div id="courbe_power" style="position: absolute; top: 500px; left: 740px;"></div>
